...
echo "mail sent successfully to bhaskaro@gmai.com"
   ...
   stage('deploy to tomcat'){
      ...
      sh "wget --http-user=deployer --http-password=welcome1 http://localhost:8080/manager/text/deploy?war=file:${WORKSPACE}/target/SpringBootTest-0.0.1-SNAPSHOT.war&path=/SpringBootTest -O -"
